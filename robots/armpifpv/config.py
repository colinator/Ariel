...
PULSE_MAP_BY_NAME = {
    ...
    "wrist_pitch": [0, 1000, 500, -120.0, 120.0, 0.0],
...
CAMERA_ENABLE = os.getenv("ARMPIFPV_CAMERA_ENABLE", "1") != "0"
...
CAMERA_DEVICE_INDEX = int(os.getenv("ARMPIFPV_CAMERA_DEVICE_INDEX", "2"))
CAMERA_USE_JPEG = os.getenv("ARMPIFPV_CAMERA_USE_JPEG", "0") != "0"
MONITOR_CAMERA_USE_JPEG = os.getenv("ARMPIFPV_MONITOR_CAMERA_USE_JPEG", "0") != "0"

REALSENSE_ENABLE = os.getenv("ARMPIFPV_REALSENSE_ENABLE", "0") == "1"
REALSENSE_SERIAL = os.getenv("ARMPIFPV_REALSENSE_SERIAL", "")
REALSENSE_WIDTH = int(os.getenv("ARMPIFPV_REALSENSE_WIDTH", "640"))
REALSENSE_HEIGHT = int(os.getenv("ARMPIFPV_REALSENSE_HEIGHT", "480"))
REALSENSE_FPS = int(os.getenv("ARMPIFPV_REALSENSE_FPS", "15"))
REALSENSE_ALIGN_TO_RGB = os.getenv("ARMPIFPV_REALSENSE_ALIGN_TO_RGB", "1") != "0"

MONITOR_ENABLE = os.getenv("ARMPIFPV_MONITOR_ENABLE", "1") != "0"
MONITOR_HZ = float(os.getenv("ARMPIFPV_MONITOR_HZ", "1.0"))
MONITOR_MAX_AGE_S = float(os.getenv("ARMPIFPV_MONITOR_MAX_AGE_S", "2.0"))
...
ZMQ_CAMERA_BIND = os.getenv("ROBOFLEX_ZMQ_CAMERA_BIND", "ipc://camerabind")
ZMQ_CAMERA_CONNECT = os.getenv("ROBOFLEX_ZMQ_CAMERA_CONNECT", "ipc://camerabind")

ZMQ_SERVO_STATE_BIND = os.getenv("ROBOFLEX_ZMQ_SERVO_STATE_BIND", "ipc://statebind")
ZMQ_SERVO_STATE_CONNECT = os.getenv("ROBOFLEX_ZMQ_SERVO_STATE_CONNECT", "ipc://statebind")

ZMQ_SERVO_CMD_BIND = os.getenv("ROBOFLEX_ZMQ_SERVO_CMD_BIND", "ipc://cmdbind")
ZMQ_SERVO_CMD_CONNECT = os.getenv("ROBOFLEX_ZMQ_SERVO_CMD_CONNECT", "ipc://cmdbind")

ZMQ_REALSENSE_BIND = os.getenv("ROBOFLEX_ZMQ_REALSENSE_BIND", "ipc://realsensebind")
ZMQ_REALSENSE_CONNECT = os.getenv("ROBOFLEX_ZMQ_REALSENSE_CONNECT", "ipc://realsensebind")

ZMQ_MONITOR_CAMERA_BIND = os.getenv("ROBOFLEX_ZMQ_MONITOR_CAMERA_BIND", "tcp://0.0.0.0:5560")
ZMQ_MONITOR_REALSENSE_BIND = os.getenv("ROBOFLEX_ZMQ_MONITOR_REALSENSE_BIND", "tcp://0.0.0.0:5561")
